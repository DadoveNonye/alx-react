...
describe("Testing the <Notifications /> Component", () => {
  ...
  it("should renders NotificationItems", () => {
...
describe("Testing <Notification displayDrawer={true}/> ", () => {
  ...
  it("should renders div.Notifications when displayDrawer is true", () => {
...
describe("Testing <Notification displayDrawer={true} listNotifications={[...]}/> ", () => {
  ...
  it("should renders correctly and with the right number of NotificationItem", () => {
